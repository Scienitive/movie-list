	...
	return (
		<>
			<Modal
				...
				className="border-1 border-ml-white bg-ml-black p-6 text-ml-white"
				onClose={closeAction}
			>
				<ModalContent>
					{() => {
						return (
							<ModalBody className="text-sm">
								...
								<ul className="ml-6 flex list-disc flex-col gap-3">
									<li>
										<p>
											...
											{`means a unique account created
									...
									<li>
										<p>
											...
											{`are small files that are placed
									...
									<li>
										<p>
											<strong>Website</strong> refers to movie-list, accessible
											from{" "}
											<a
												href="https://movielist.alyasar.dev"
												rel="external nofollow noopener"
												target="_blank"
											>
												https://movielist.alyasar.dev
											</a>
										</p>
									</li>
									<li>
								...
								<p>
									...
									contact us by email: altugyasar42@gmail.com
								</p>
							</ModalBody>
						);
					}}
			...
			<Button
				className="h-[10px] w-[60px] bg-transparent px-1 text-center text-[8px] text-ml-white text-ml-white/50 sm:h-[12px] sm:w-auto sm:text-[10px]"
				disableRipple={true}
				onClick={() => {
					setIsOpen((prev) => !prev);
				}}
